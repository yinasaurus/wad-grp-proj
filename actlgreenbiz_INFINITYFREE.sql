-- ================================================================
-- GREEN BUSINESS DIRECTORY - SQL FILE FOR INFINITYFREE
-- ================================================================
-- INSTRUCTIONS:
-- 1. In InfinityFree, go to phpMyAdmin
-- 2. Click on your database name in the left sidebar
-- 3. Click the "Import" tab
-- 4. Choose this file and click "Go"
-- ================================================================

-- NOTE: Do NOT use CREATE DATABASE - InfinityFree already created it for you!
-- NOTE: Do NOT use USE statement - phpMyAdmin uses the selected database automatically
...
-- Firebase removed - using MySQL-only authentication
-- firebase_uid column no longer needed as we're using MySQL-based authentication
-- If you have existing databases with this column, you can safely ignore it or remove it:
...
-- Insert Dummy Events
INSERT INTO events (title, description, start_time, end_time, location, organizer_id, organizer_type) VALUES
('Green Business Networking Event', 'Join us for a networking session focused on sustainable business practices. Connect with like-minded entrepreneurs, share ideas, and learn about the latest green initiatives. Free entry with refreshments provided.', DATE_ADD(NOW(), INTERVAL 7 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 7 DAY), INTERVAL 3 HOUR), 'Marina Bay Sands Convention Centre, Singapore', 1, 'consumer'),
('Sustainable Living Workshop', 'Learn practical tips for reducing your carbon footprint at home. Topics include energy conservation, waste reduction, sustainable shopping habits, and eco-friendly home improvements. Suitable for beginners!', DATE_ADD(NOW(), INTERVAL 10 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 10 DAY), INTERVAL 2 HOUR), 'Community Centre, Tampines', 2, 'consumer'),
('Solar Energy Open House', 'Visit our showroom and learn about solar energy solutions for your home or business. Free consultations, demonstrations, and Q&A sessions with our solar experts. Special discounts available!', DATE_ADD(NOW(), INTERVAL 14 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 14 DAY), INTERVAL 5 HOUR), '50 Jurong Gateway Road, Singapore 608549', 3, 'business'),
('Zero-Waste Shopping Tour', 'Join us for a guided tour of zero-waste shopping practices. Learn how to shop package-free, reduce plastic waste, and make sustainable choices. Includes hands-on experience at our store!', DATE_ADD(NOW(), INTERVAL 5 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 5 DAY), INTERVAL 1 HOUR), '10 Tampines Central, Singapore 529536', 4, 'business'),
('Green Building Materials Exhibition', 'Explore sustainable construction materials and learn about eco-friendly building practices. Meet suppliers, architects, and industry experts. Free admission for all attendees.', DATE_ADD(NOW(), INTERVAL 21 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 21 DAY), INTERVAL 6 HOUR), 'Singapore Expo, Hall 5', 5, 'business'),
('Carbon Footprint Reduction Seminar', 'Understanding your carbon footprint and how to reduce it. Learn about carbon offsetting, renewable energy options, and sustainable business practices. Includes certification workshop.', DATE_ADD(NOW(), INTERVAL 12 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 12 DAY), INTERVAL 4 HOUR), '20 Cecil Street, Singapore 049705', 6, 'business'),
('Community Garden Planting Day', 'Help us plant vegetables and herbs in our community garden! Learn about urban farming, composting, and sustainable food practices. All materials provided. Family-friendly event.', DATE_ADD(NOW(), INTERVAL 3 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 3 DAY), INTERVAL 3 HOUR), 'Community Garden, Orchard Road', 3, 'consumer'),
('E-Waste Recycling Drive', 'Bring your old electronics for proper recycling! We accept phones, laptops, tablets, and other electronic devices. Learn about responsible e-waste disposal and get a free consultation on reducing electronic waste.', DATE_ADD(NOW(), INTERVAL 8 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 8 DAY), INTERVAL 4 HOUR), '1 Marina Boulevard, Singapore 018989', 1, 'business'),
('Sustainable Fashion Pop-up', 'Discover eco-friendly fashion brands and learn about sustainable clothing choices. Featuring local designers using recycled materials and ethical manufacturing practices.', DATE_ADD(NOW(), INTERVAL 15 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 15 DAY), INTERVAL 5 HOUR), '100 Orchard Road, Singapore 238840', 2, 'business'),
('Green Tech Innovation Showcase', 'Explore cutting-edge green technology solutions for businesses. Meet innovators, see live demonstrations, and network with sustainability leaders. Ideal for tech enthusiasts and business owners.', DATE_ADD(NOW(), INTERVAL 18 DAY), DATE_ADD(DATE_ADD(NOW(), INTERVAL 18 DAY), INTERVAL 6 HOUR), 'Singapore Science Centre', 1, 'business');

-- ================================================================
-- IMPORT COMPLETE!
-- ================================================================
-- Your database has been successfully imported!
-- You can now use your website with InfinityFree.
-- ================================================================
